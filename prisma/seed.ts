...
async function main() {
    ...
    await prisma.usuarios.createMany({
        data: [
          { NombreUsuario: 'Fernando Cespedes', CorreoUsuario: 'admin@example.com', ContrasenaUsuario: 'admin123', Rol: 'Administrador' , Token:""},
          { NombreUsuario: 'Laura García', CorreoUsuario: 'asistente@example.com', ContrasenaUsuario: 'asistente123', Rol: 'Asistente' , Token:""},
          { NombreUsuario: 'Carlos Martínez', CorreoUsuario: 'auditor@example.com', ContrasenaUsuario: 'auditor123', Rol: 'Auditoria' , Token:""},
          { NombreUsuario: 'María Rodríguez', CorreoUsuario: 'admin2@example.com', ContrasenaUsuario: 'admin1234', Rol: 'Administrador' , Token:""},
          { NombreUsuario: 'Pedro López', CorreoUsuario: 'asistente2@example.com', ContrasenaUsuario: 'asistente1234', Rol: 'Asistente' , Token:""},
          { NombreUsuario: 'Ana Fernández', CorreoUsuario: 'ana@example.com', ContrasenaUsuario: 'ana123', Rol: 'Administrador', Token:"" },
          { NombreUsuario: 'José González', CorreoUsuario: 'jose@example.com', ContrasenaUsuario: 'jose123', Rol: 'Asistente' , Token:""},
          { NombreUsuario: 'Marta Sánchez', CorreoUsuario: 'marta@example.com', ContrasenaUsuario: 'marta123', Rol: 'Auditoria', Token:""},
          { NombreUsuario: 'Luis Pérez', CorreoUsuario: 'luis@example.com', ContrasenaUsuario: 'luis123', Rol: 'Administrador', Token:"" },
          { NombreUsuario: 'Elena Ramírez', CorreoUsuario: 'elena@example.com', ContrasenaUsuario: 'elena123', Rol: 'Asistente', Token:"" },
          { NombreUsuario: 'Jorge Torres', CorreoUsuario: 'jorge@example.com', ContrasenaUsuario: 'jorge123', Rol: 'Auditoria' , Token:""},
          { NombreUsuario: 'Carmen Díaz', CorreoUsuario: 'carmen@example.com', ContrasenaUsuario: 'carmen123', Rol: 'Administrador' , Token:""},
          { NombreUsuario: 'Roberto Gómez', CorreoUsuario: 'roberto@example.com', ContrasenaUsuario: 'roberto123', Rol: 'Asistente' , Token:""},
          { NombreUsuario: 'Isabel Ruiz', CorreoUsuario: 'isabel@example.com', ContrasenaUsuario: 'isabel123', Rol: 'Auditoria' , Token:""},
