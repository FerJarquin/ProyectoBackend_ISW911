...
async function main() {
    ...
    await prisma.usuarios.createMany({
        data: [
          { NombreUsuario: 'Fernando Cespedes', CorreoUsuario: 'admin1@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Administrador' , Token:""},
          { NombreUsuario: 'Laura García', CorreoUsuario: 'asistente@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Asistente' , Token:""},
          { NombreUsuario: 'Carlos Martínez', CorreoUsuario: 'auditor@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Auditoria' , Token:""},
          { NombreUsuario: 'María Rodríguez', CorreoUsuario: 'admin2@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Administrador' , Token:""},
          { NombreUsuario: 'Pedro López', CorreoUsuario: 'asistente2@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Asistente' , Token:""},
          { NombreUsuario: 'Ana Fernández', CorreoUsuario: 'ana@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Administrador', Token:"" },
          { NombreUsuario: 'José González', CorreoUsuario: 'jose@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Asistente' , Token:""},
          { NombreUsuario: 'Marta Sánchez', CorreoUsuario: 'marta@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Auditoria', Token:""},
          { NombreUsuario: 'Luis Pérez', CorreoUsuario: 'luis@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Administrador', Token:"" },
          { NombreUsuario: 'Elena Ramírez', CorreoUsuario: 'elena@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Asistente', Token:"" },
          { NombreUsuario: 'Jorge Torres', CorreoUsuario: 'jorge@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Auditoria' , Token:""},
          { NombreUsuario: 'Carmen Díaz', CorreoUsuario: 'carmen@example.com', ContrasenaUsuario: '$2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Administrador' , Token:""},
          { NombreUsuario: 'Roberto Gómez', CorreoUsuario: 'roberto@example.com', ContrasenaUsuario: '2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Asistente' , Token:""},
          { NombreUsuario: 'Isabel Ruiz', CorreoUsuario: 'isabel@example.com', ContrasenaUsuario: '2b$10$I5tAU9pOKcTjvKp/TzLgX.9.5pm5mE52zXQ/sqas2p/ckgzfhuq0u', Rol: 'Auditoria' , Token:""},
          { NombreUsuario: 'Francisco Moreno', CorreoUsuario: 'francisco@example.com', ContrasenaUsuario: 'francisco123', Rol: 'Administrador', Token:"" },
          { NombreUsuario: 'test', CorreoUsuario: 'test@example.com', ContrasenaUsuario: '$2b$10$6Nhv0VHwLxiF19YgfLyTlOuO/ILI5XGbjR.6aP2DROGpJgTVFZP4i', Rol: 'Administrador', Token:"" }
        ],
      })
    ...
    await prisma.programacion.createMany({
        data: [
            ...
            {UsuarioId: 2, EstadoProgramacion: 'Pendiente',SolicitudId: 25}
